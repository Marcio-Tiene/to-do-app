...
import { postProject } from '../querys/ProjectQueries';
...
export default function CreateProjectCard() {
  ...
  return (
    <article className="rounded-xl bg-zinc-200 gap-5 flex flex-col items-center justify-center w-[350px] max-w-full h-[250px] max-h-full shadow-elevation">
      ...
      <TextInput name="create-project" label="Create a new project" wrapperClassname="text-2xl text-center max-w-[95%]" placeholder="Project Name" inputClassName="text-left mt-1" value={title} onChange={(e) => { setTitle(e.target.value); }} />
      <button
